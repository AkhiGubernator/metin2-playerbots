    ...
    <div style="display:flex;flex-wrap:wrap;align-items:center;justify-content:space-between;gap:12px">
      ...
      <div style="display:flex;align-items:center;gap:6px">
        ...
        <select id="mapFilter" onchange="setMapFilter(this.value)" style="width:auto;padding:6px 9px;font-size:12px;margin:0">
          ...
          <option value="64">{{m.orc}}</option><option value="63">{{m.desert}}</option><option value="43">{{m.sohan}}</option><option value="104">{{m.spider}}</option>
        </select>
      </div>
...
PLAYERBOT_MAP_BOUNDS = {
    ...
    43: (819200, 204800, 102400, 102400),   # Mount Sohan
