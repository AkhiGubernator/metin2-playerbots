...
EDITS = {
    ...
    'uigameoption.py': [
        ...
        (b'\tdef __OnClickFloatingTextButton(self, state):\r\n'
         ...
         b'\t\tself.RefreshBotTitleButtons()\r\n'
         b'\t\t# A title already drawn stays until the bot\'s next alignment change (textTail\r\n'
         b'\t\t# has no detach), so the switch shows on the next login - say so (Tieru).\r\n'
         b'\t\tchat.AppendChat(chat.CHAT_TYPE_INFO, \"Tytu\\xb3y bot\\xf3w: zmiana b\\xeadzie widoczna po ponownym zalogowaniu.\")\r\n'
         b'\r\n'
